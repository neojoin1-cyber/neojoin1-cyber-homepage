const CAMPAIGN_ID = "fair-start-partnership-202608-v2";
  ...
  layer.innerHTML = `
    <div class="board-home-popup-dialog">
      ...
      <a class="partnership-popup-art" href="${CAMPAIGN_LINK}" aria-label="설탕과소금 제휴기관 모집 자세히 보기">
        <picture>
          <source media="(max-width: 620px)" srcset="assets/partnership-fair-start-mobile.webp?v=20260818-partnership-v2">
          <img src="assets/partnership-fair-start-desktop.webp?v=20260818-partnership-v2" width="1672" height="941" alt="공정한 출발선을 함께 넓히는 설탕과소금 제휴기관 모집. 구매자 10퍼센트 추가 할인, 판매액 20퍼센트 제휴기관 발전금">
        </picture>
      </a>
    </div>`;
