...
check("manager.launch-readiness", edge.includes("launchReadiness") && managerJs.includes("state.launchReadiness?.enabled") && managerJs.includes("발송 준비 확인 필요"), "시작·접근·메일 설정이 모두 준비됐을 때만 개별 시작 버튼을 활성화합니다.");
