...
check("tools.large-review", html.includes("큰 화면 검수") && html.includes("원래 화면으로 돌아가기") && html.includes("20260813-4") && html.includes('aria-pressed="false"') && js.includes("setFocusMode") && js.includes("readerBaseFontSize") && css.includes("body.focus-mode .document-sidebar") && css.includes("body.focus-mode .annotation-panel") && css.includes("min(1760px"), "대형 모니터에서는 목차와 검수의견을 유지하며 원고 폭과 글자 크기를 함께 확대하고 명확한 복귀 버튼을 제공합니다.");
