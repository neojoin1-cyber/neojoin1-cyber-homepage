...
check("deployment.review-asset-version", html.includes("review.css?v=20260815-2") && html.includes("review.js?v=20260815-6") && managerHtml.includes("manage.js?v=20260815-5") && managerHtml.includes("manage.css?v=20260815-5"), "일반 새로고침만으로도 전문위원·관리자 화면이 최신 검수 코드를 받습니다.");
...
check("manager.stage-legend", managerHtml.includes("수행 완료") && managerHtml.includes("다음 단계") && managerHtml.includes("채움=완료 · 황동 테두리=다음"), "채운 원은 수행 완료, 황동 테두리는 다음 차례임을 명확히 설명합니다.");
