...
check("deployment.review-asset-version", html.includes("review.css?v=20260815-3") && html.includes("review.js?v=20260815-7") && managerHtml.includes("manage.js?v=20260815-9") && managerHtml.includes("manage.css?v=20260815-9"), "일반 새로고침만으로도 전문위원·관리자 화면이 최신 검수 코드를 받습니다.");
check("review.live-presence", js.includes('api("heartbeat"') && edge.includes('action === "heartbeat"') && edge.includes('from("review_presence")') && managerHtml.includes('id="summary-online"') && managerJs.includes('presenceStatus==="online"'), "워크룸의 최신 접속상태를 별도 최신값으로 갱신하고 관제 화면에 현재 검수 중·자리 비움·오프라인을 구분합니다.");
