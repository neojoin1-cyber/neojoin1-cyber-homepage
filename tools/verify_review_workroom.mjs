...
check("deployment.review-asset-version", html.includes("review.css?v=20260815-3") && html.includes("review.js?v=20260815-7") && managerHtml.includes("manage.js?v=20260815-8") && managerHtml.includes("manage.css?v=20260815-8"), "일반 새로고침만으로도 전문위원·관리자 화면이 최신 검수 코드를 받습니다.");
...
check("manager.communication-repair", managerHtml.includes('id="repair-start-notice"') && managerJs.includes('data-notice-repair-id') && managerJs.includes("managerResendStartNotice") && edge.includes('action === "managerResendStartNotice"') && edge.includes("assignment-start-v2-repair") && edge.includes("assignment_notice_record_repaired"), "후속 검수 기록은 있지만 개시 안내 기록만 누락된 예외를 관제 목록에서 바로 확인하고 중복 없이 복구합니다.");
