...
check("deployment.review-asset-version", html.includes("review.js?v=20260815-2") && managerHtml.includes("manage.js?v=20260815-3"), "일반 새로고침만으로도 전문위원·관리자 화면이 최신 검수 코드를 받습니다.");
