...
async function validateCoreContentPages() {
  ...
  fail('core.vocational-priority-layout', vocational.includes('class="vh-product"') && vocational.includes('혼자 준비하던 네 가지 취업교육') && vocational.includes('class="vh-teacher-needs"') && vocational.includes('교육부 직업공통능력 인증평가') && vocational.includes('NCS 직업공통능력평가') && vocational.includes('고졸 채용 면접스킬') && vocational.includes('모의 인성평가') && vocational.includes('모든 학생의 기초') && vocational.includes('취업 우수반의 실전') && vocational.includes('class="vh-product-gallery"') && vocational.includes('class="vh-product-statement"') && vocational.includes('class="vh-classroom"') && vocational.includes('class="vh-jobs-title-button" href="jobs.html"') && vocational.includes('특성화(마이스터)고') && vocational.includes('data-live-jobs') && vocational.indexOf('href="learning-app.html#trial-accounts"') < vocational.indexOf('href="jobs.html"') && ['href="forms.html"', 'href="guides.html"', 'href="counseling-room.html"'].every((link) => vocational.includes(link)), '특성화고 교육지원센터는 선생님의 네 가지 취업교육 어려움과 설탕과소금앱의 실제 학생·교사 화면을 첫 화면에서 연결한 뒤 고졸 채용정보와 서식·지침·상담을 안내합니다.');
