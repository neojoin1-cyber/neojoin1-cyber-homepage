...
async function validateCoreContentPages() {
  ...
  fail('core.public-service-entrypoints', homePage.includes('class="home-free-mock home-continuity-banner"') && homePage.includes('href="exams.html?v=20260802-navfix1"') && homePage.includes('10개년 기출의 내용·구조·형식 분석') && exams.includes('class="branch-free-mock"') && exams.includes('href="#engine"') && exams.includes('href="exam-service.html?service=civil"') && exams.includes('10개년 기출 × T1·T2·T3') && examService.includes('https://0mu1.gyo6.kr/'), '메인은 교육 실천의 연속성과 공직시험 연구소를 연결하고, 연구소는 10개년 분석·단계별 엔진 기준과 공무원관 진입 경로를 제공합니다.');
  ...
  fail('home.exam-lab-positioning', homePage.includes('<strong>공직시험 연구소</strong>') && homePage.includes('초·중등 교원임용 · 지방직 7급') && homePage.includes('10개년 기출의 내용·구조·형식 분석') && homePage.includes('T1·T2·T3 단계 설계 · 적대적 검증'), '메인 두 번째 사업 카드가 공직시험 연구소의 공개 범위와 새 제작 기준을 정확히 안내합니다.');
  ...
  fail('core.exam-service-links', exams.includes('href="exam-service.html?service=elementary"') && exams.includes('href="exam-service.html?service=secondary"') && exams.includes('href="exam-service.html?service=civil"') && examService.includes('https://chodeung.gyo6.kr/') && examService.includes('https://imyong.gyo6.kr/') && examService.includes('https://0mu1.gyo6.kr/') && examService.includes('id="service-frame"') && exams.includes('10개년 전수분석 · 현행 기준') && exams.includes('고난도 실전 모의고사 10회') && exams.includes('T1 · EVIDENCE LAYER') && exams.includes('T3 · ADVERSARIAL LAYER') && !exams.includes('suneung.gyo6.kr') && !exams.includes('수능시험'), '공직시험 연구소가 포털 상단 메뉴를 유지한 내부 화면에서 초등·중등 임용과 10개년 분석·단계별 엔진 기반 지방직 7급 시험을 제공하며 수능 메뉴는 제외됩니다.');
