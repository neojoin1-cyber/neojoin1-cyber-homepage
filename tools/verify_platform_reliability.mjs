...
async function validateCoreContentPages() {
  ...
  fail('core.vocational-priority-layout', vocational.includes('class="app-hero"') && vocational.includes('학생의 취업 준비를') && vocational.includes('한 학교의 모든 학생과') && vocational.includes('취업 우수반') && vocational.includes('class="app-teacher-section"') && vocational.indexOf('href="learning-app.html#trial-accounts"') < vocational.indexOf('href="jobs.html"') && ['href="forms.html"', 'href="guides.html"', 'href="counseling-room.html"'].every((link) => vocational.includes(link)), '특성화고 교육지원센터는 학습앱을 첫 화면의 주인공으로 두고 전체 학생·취업 우수반·교사용 수업 흐름을 먼저 설명한 뒤 채용정보·서식·지침·상담을 보조망으로 연결합니다.');
