...
async function validateCoreContentPages() {
  ...
  const portalPopup = await readText('assets/portal-popup.js');
  ...
  fail('core.partnership-popup', homePage.includes('assets/portal-popup.js') && portalPopup.includes('fair-start-partnership-202608') && portalPopup.includes('localStorage.setItem') && portalPopup.includes('설탕과소금 제휴기관 모집 자세히 보기') && portalPopup.includes('partners.html?from=popup') && !portalPopup.includes('board-home-popup-actions') && boardEnhancements.includes('.partnership-popup'), '공정한 출발선 제휴기관 모집 팝업을 캠페인별 한 번만 반응형 표시하며 이미지 하단을 가리는 별도 동작 버튼을 두지 않습니다.');
  fail('core.free-mock-entrypoints', homePage.includes('class="home-free-mock"') && homePage.includes('free=1&amp;from=home') && exams.includes('class="branch-free-mock"') && exams.includes('free=1&amp;from=exams') && examService.includes('destination.hash = "public-free-preview"'), '메인과 공직시험 연구소에서 포털 상단을 유지한 채 국가직 7급 무료 체험으로 바로 연결합니다.');
  ...
  fail('home.exam-lab-positioning', homePage.includes('<strong>공직시험 연구소</strong>') && homePage.includes('초·중등 교원임용시험 · 공무원시험') && homePage.includes('핵심노트 · 모의고사 · 심층면접 학습자료 개발'), '메인 두 번째 사업 카드가 공직시험 연구소의 시험 범위와 개발 자료를 정확히 안내합니다.');
  ...
  fail('core.vocational-priority-layout', vocational.includes('class="branch-card-grid vocational-service-grid"') && vocational.indexOf('href="jobs.html"') < vocational.indexOf('href="learning-app.html"') && vocational.indexOf('href="learning-app.html"') < vocational.indexOf('href="forms.html"') && vocational.indexOf('href="forms.html"') < vocational.indexOf('href="guides.html"') && vocational.indexOf('href="guides.html"') < vocational.indexOf('href="counseling-room.html"') && !vocational.includes('학교 현장을 위한 다섯 가지 연결') && !vocational.includes('vocational-role-grid'), '특성화고 교육지원센터는 채용정보와 학습앱을 첫 줄에 강조하고 서식·지침·상담을 둘째 줄에 배치하며 중복 설명 영역을 제거합니다.');
  fail('core.exam-service-links', exams.includes('href="exam-service.html?service=elementary"') && exams.includes('href="exam-service.html?service=secondary"') && exams.includes('href="exam-service.html?service=civil"') && examService.includes('https://chodeung.gyo6.kr/') && examService.includes('https://imyong.gyo6.kr/') && examService.includes('https://0mu1.gyo6.kr/') && examService.includes('id="service-frame"') && exams.includes('국가직 7급 일반행정') && !exams.includes('7급 지방직') && exams.includes('경제학 · 행정법 · 행정학 · 헌법') && !exams.includes('suneung.gyo6.kr') && !exams.includes('수능시험'), '공직시험 연구소가 국가직 7급 공개 범위만 안내하고, 포털 상단 메뉴를 유지하는 내부 화면에서 초등·중등 임용과 공무원시험을 제공하며 수능 메뉴는 제외됩니다.');
