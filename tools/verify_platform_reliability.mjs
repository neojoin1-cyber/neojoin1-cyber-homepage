...
async function validateCoreContentPages() {
  ...
  fail('core.free-mock-popup', homePage.includes('assets/portal-popup.js') && portalPopup.includes('national-7-free-mock-202608') && portalPopup.includes('localStorage.setItem') && portalPopup.includes('무료 모의고사 시작하기') && portalPopup.includes('free=1&from=popup') && boardEnhancements.includes('.free-mock-popup'), '국가직 7급 무료 모의고사 팝업을 캠페인별 한 번만 반응형 표시합니다.');
