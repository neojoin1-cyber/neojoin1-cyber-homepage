...
async function validateCoreContentPages() {
  ...
  fail('core.vocational-priority-layout', vocational.includes('class="vh-product"') && vocational.includes('설탕과소금앱') && vocational.includes('취업 필수 4영역') && vocational.includes('모든 학생의 기초') && vocational.includes('취업 우수반의 실전') && vocational.includes('class="vh-product-gallery"') && vocational.includes('class="vh-classroom"') && vocational.includes('고졸 채용정보, 한자리에') && vocational.includes('data-live-jobs') && vocational.indexOf('href="learning-app.html#trial-accounts"') < vocational.indexOf('href="jobs.html"') && ['href="forms.html"', 'href="guides.html"', 'href="counseling-room.html"'].every((link) => vocational.includes(link)), '특성화고 교육지원센터는 설탕과소금앱을 첫 화면의 주인공으로 두고 실제 학생·교사 화면과 전체 학생·취업 우수반·교사용 수업 흐름을 먼저 설명한 뒤 고졸 채용정보와 서식·지침·상담을 연결합니다.');
  ...
  fail('core.learning-app-trial-link', vocational.includes('href="learning-app.html#trial-accounts"') && !vocational.includes('href="learning-app.html#trial-accounts" target="_blank"') && vocational.includes('설탕과소금 학습앱') && learningAppViewer.includes('class="service-viewer-body learning-trial-page"') && learningAppViewer.includes('id="trial-accounts"') && ['demo.student@sugarsalt.kr', 'demo.teacher@sugarsalt.kr', 'demo.admin@sugarsalt.kr'].every((account) => learningAppViewer.includes(account)) && learningAppViewer.includes('id="service-frame"') && learningAppViewer.includes('src="apps/sugar-salt/"'), '특성화고 교육지원센터는 포털 메뉴 아래에서 학생·교사·학교관리자 계정을 안내하고 로그인형 학습앱을 직접 확인하는 내부 체험 화면으로 연결됩니다.');
