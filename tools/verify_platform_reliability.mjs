...
async function validateCoreContentPages() {
  ...
  fail('core.partnership-popup', homePage.includes('assets/portal-popup.js') && portalPopup.includes('fair-start-partnership-202608') && portalPopup.includes('localStorage.setItem') && portalPopup.includes('제휴 안내 자세히 보기') && portalPopup.includes('partners.html?from=popup') && boardEnhancements.includes('.partnership-popup'), '공정한 출발선 제휴기관 모집 팝업을 캠페인별 한 번만 반응형 표시합니다.');
