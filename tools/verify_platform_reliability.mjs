...
async function validateCoreContentPages() {
  ...
  fail('core.vocational-priority-layout', vocational.includes('class="vh-product"') && vocational.includes('필수 취업교육 4영역') && vocational.includes('모든 학생의 기초') && vocational.includes('취업 우수반의 실전') && vocational.includes('class="vh-classroom"') && vocational.includes('data-live-jobs') && vocational.indexOf('href="learning-app.html#trial-accounts"') < vocational.indexOf('href="jobs.html"') && ['href="forms.html"', 'href="guides.html"', 'href="counseling-room.html"'].every((link) => vocational.includes(link)), '특성화고 교육지원센터는 학습앱을 첫 화면의 주인공으로 두고 전체 학생·취업 우수반·교사용 수업 흐름을 먼저 설명한 뒤 실제 채용 피드와 서식·지침·상담을 연결합니다.');
