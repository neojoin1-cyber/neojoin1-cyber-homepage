...
async function validateCoreContentPages() {
  ...
  fail('core.exam-service-links', exams.includes('href="exam-service.html?service=elementary"') && exams.includes('href="exam-service.html?service=secondary"') && exams.includes('href="exam-service.html?service=civil"') && examService.includes('https://chodeung.gyo6.kr/') && examService.includes('https://imyong.gyo6.kr/') && examService.includes('https://0mu1.gyo6.kr/') && examService.includes('id="service-frame"') && exams.includes('최근 8개년 전수분석 · 현행 기준') && exams.includes('고난도 실전점검 10회') && !exams.includes('suneung.gyo6.kr') && !exams.includes('수능시험'), '공직시험 연구소가 포털 상단 메뉴를 유지한 내부 화면에서 초등·중등 임용과 새 제작 기준의 공무원시험을 제공하며 수능 메뉴는 제외됩니다.');
