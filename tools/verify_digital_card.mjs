...
assert.match(publicPage, /href="tel:\+821035347163" aria-label="휴대전화 010-3534-7163"/);
assert.match(publicPage, /href="tel:\+82547727576" aria-label="사무실 전화 054-772-7576"/);
...
assert.match(publicScript, /TEL;TYPE=CELL/);
assert.match(publicScript, /TEL;TYPE=WORK,VOICE/);
assert.match(publicScript, /PROFILE\.mobile \|\| PROFILE\.phone/);
